...
-- version: 20260723124347
-- name: f22_evaluate_winners_fix_enum
-- projeto: gzjwnjdpxpbmdhcyefvs (Gestor de Trafego IA)
-- aplicada por: Claude via MCP apply_migration
-- espelho gerado a partir de supabase_migrations.schema_migrations - NAO transcrito a mao

-- fix: recommendation_status é enum (new, accepted, dismissed). 'pendente' -> 'new';
-- preservadas as tratadas (accepted/dismissed). Resto idêntico à f22_evaluate_winners.
