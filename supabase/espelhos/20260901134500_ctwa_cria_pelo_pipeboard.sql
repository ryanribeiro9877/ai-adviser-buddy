...
-- version: 20260901134500
-- name: ctwa_cria_pelo_pipeboard
...
-- O fato 217 (migration 20260901130000) leu a auditoria das 11:49 UTC como "o numero
    10|-- precisa estar numa WABA". A comparacao controlada de 12:46 UTC desmentiu isso:
--
...
--                            -> conjunto 120249829825270182 criado e reconciliado
--
-- Mesma conta, mesma Pagina, mesmos digitos, mesmo minuto de codigo: a unica variavel
    20|-- foi o driver. Os quatro numeros VISTTA continuam fora de qualquer WABA e mesmo assim
