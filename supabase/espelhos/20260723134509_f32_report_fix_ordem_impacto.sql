...
-- version: 20260723134509
-- name: f32_report_fix_ordem_impacto
-- projeto: gzjwnjdpxpbmdhcyefvs (Gestor de Trafego IA)
-- aplicada por: Claude via MCP apply_migration
-- espelho gerado a partir de supabase_migrations.schema_migrations - NAO transcrito a mao

-- fix cosmético: "Depende de você" ordena high (🚀) antes de medium (💡).
-- Única mudança vs f32_post_daily_report: o ORDER BY do string_agg de recomendações.
