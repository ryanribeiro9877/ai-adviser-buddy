...
-- version: 20260820132000
-- name: teto_horario_slate_exclui_falhas
-- projeto: gzjwnjdpxpbmdhcyefvs (Gestor de Trafego IA)
-- aplicada por: Cursor agent via MCP apply_migration
-- espelho gerado a partir do SQL aplicado - NAO transcrito a mao
