...
-- version: 20260812175149
-- name: esp25_escalar_duplicar_corpo
...
values (
  ...
  || 'NAO sao copiados neste card â€” use criar_anuncio_a_partir_de depois. alterar_orcamento '
  || 'continua sendo EDICAO de verba no conjunto existente (propose+execute+ESP-26+update_adset); '
  || 'caminho estrutural validado 12/08 (flag ligada, juiz na proposta e na fila) â€” ainda sem '
