// supabase/functions/traffic-chat/index.ts (v28.84)
...
- WHATSAPP NO CONJUNTO (01/09/2026 v28.84): destino MANUAL so WhatsApp — destination_type=WHATSAPP. Messenger OFF. PROIBIDO MESSAGING_MESSENGER_WHATSAPP e destino automatico. Numero no formato +55 71 9189-4229 ou 55+DDD+8. get_whatsapp_da_pagina NAO e o seletor da Pagina: casou_na_api=false NAO recusa. Pedido "vamos aos conjuntos" = EMITIR no agente (campanha de teste no Gerenciador sera excluida pelo gestor — NAO use como molde). PROIBIDO numero Juridico em VISTTA. Se o card falhou 1487246, peca reexecutar.
...
destination_type=WHATSAPP (Messenger OFF). whatsapp_phone_number no formato +55 71 9189-4229
ou 55+DDD+8. PROIBIDO MESSAGING_MESSENGER_WHATSAPP. PROIBIDO destino automatico.
