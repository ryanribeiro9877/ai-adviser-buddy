...
const TOOLS = [
  ...
  { type: "function", function: { name: "get_acervo_para_anuncio", description: "LEITURA TOTAL do acervo do Drive. SEMPRE taxonomia_drive + inventario_global. Videos 22/23/25/26/27 estao LIBERADOS (FIN-04 v3) — NAO diga bloqueados. Carrossel Meta HABILITADO via child_attachments (2-10 image_hash). Capas, Cards instrucionais, 19 videos. Em lote/mix: chame SEM produto primeiro.", parameters: { type: "object", properties: { produto: { type: "string", description: "Opcional. Em lote/mix deixe vazio na 1a chamada." }, incluir_inaptas: { type: "boolean", description: "Padrao true." } } } } },
...
- MONTAR ANUNCIO NOVO / ESCOLHER PECA DO ACERVO / LOTE MIX: a fonte e get_acervo_para_anuncio
  ...
  (FIN-04 v3) — NAO diga que estao bloqueados; use com legenda contendo CET + ressalva;
  (4) CARROSSEL Meta HABILITADO: params.child_attachments = 2 a 10 slides com image_hash cada
