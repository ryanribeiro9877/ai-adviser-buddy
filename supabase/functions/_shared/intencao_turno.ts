 ...
 *
 * Medido 22/09/2026 (Ocular): "traga as mesmas informacoes / valores dos conjuntos"
 * NAO e follow-up do "altere vermelho e amarelo" — e leitura nova. Sem esta guarda
 ...
 * "nao da para separar vermelho e amarelo". Medido 22/09/2026 (Ocular):
 * get_detalhe_anuncios JA tinha custo_por_resultado por conjunto; vermelho/
 * amarelo/verde neste fio e a classificacao do turno do Juridico, nao um
...
/**
 * Alterar orcamento por cor/desempenho precisa da tool de metrica no mesmo
 * turno (AG-02). Sem isso o Executor so tem propose_action e recusa.
 */
...
/**
 * Pedido de valores/tabela dos conjuntos em que a prosa so falou de card
 * (ou nao montou tabela). As tools podem ter o numero; a resposta nao.
 */
