...
assert(job.includes("aplicarResgateTimeout"), "job resgata hang/vazio trocando o primario");
...
assert(chat.includes("aplicarResgateTimeout"), "chat resgata hang/vazio trocando o primario");
