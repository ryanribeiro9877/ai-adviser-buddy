  ...
  try {
    switch (name) {
      ...
      case "checar_par_texto_e_peca": {
        if (String(args.company_id ?? "") === COMPANY_COHAPM) {
          const cruz = recusarCruzamentoLinhaProduto({
            estruturaNomes: [args.campanha, args.conjunto, args.campanha_destino],
