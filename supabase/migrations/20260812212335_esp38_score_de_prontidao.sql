...
--
-- A prontidao para o agente propor/executar anuncios estava espalhada: config em
-- meta_execution_config, saude_das_integracoes, pode_executar_acao/resolver_driver (ESP-29),
-- ler_brand_identity (ESP-36), destino_por_produto. ESP-38 agrega tudo num score 0-100 com
-- nivel, checks itemizados, bloqueios duros e recomendacoes. Leitura pura: NAO altera nada e
-- NAO substitui os gates por pedido (validar_pedido_contra_contrato / pedido_de_anuncio_completo).
--
-- Aplicada como version 20260812212335. Espelho fiel em
-- supabase/espelhos/20260812212335_esp38_score_de_prontidao.sql
