-- Procedencia do conserto do portao do molde (20260811180110).
-- SQL identico ao aplicado, extraido de supabase_migrations.schema_migrations
-- via RPC espelhos_de_migracao - nao transcrito a mao.
