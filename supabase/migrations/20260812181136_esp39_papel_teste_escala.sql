...
-- papel TESTE|ESCALA no nome da campanha; montar_nome_meta aceita papel;
-- doutrina + contrato (criar/renomear campanha + escalar_duplicar.campanha_destino).
...
-- Revoga doutrina ESP-40 pura (substituida pela versao com papel).
