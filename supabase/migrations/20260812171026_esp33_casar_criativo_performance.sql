-- ESP-33: casamento read-only peca Drive ↔ anuncio criado pelo sistema ↔ metricas + amostra.
-- Fonte do vinculo: approval_requests (criar_anuncio_a_partir_de) com drive_file_id e id_criado.
-- Anuncios criados fora do sistema NAO aparecem — lacuna declarada no retorno.
-- Aplicada como version 20260812171026. Espelho fiel em
-- supabase/espelhos/20260812171026_esp33_casar_criativo_performance.sql
