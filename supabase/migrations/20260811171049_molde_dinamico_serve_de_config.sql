...
-- ============================================================================
-- 1 - VALORES DA CONFIG, NAO SO BOOLEANOS
-- ============================================================================
...
-- ============================================================================
-- 3 - PORTAO LE serve_de_molde_video
-- ============================================================================
...
begin
  ...
  loop
    ...
    if v_regra.propriedade = 'is_dynamic_creative' then
      ...
      -- molde_expoe_video_data passou a ler serve_de_molde_video: o molde serve se carrega
      -- a CONFIG de video (story video_data OU asset_feed com videos+link+CTA), nao so se
      -- expoe a chave video_data. page_id e link continuam nos booleanos dedicados.
...
-- Mensagem atualizada: o molde sem CONFIG de video (nao so sem a chave video_data).
...
-- Fato para o agente: o teto de moldes deixou de ser "so 8 com video_data".
