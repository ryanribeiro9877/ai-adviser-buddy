...
const FALAS = [
  ...
  "Traffic Campaign",
  "Sales Campaign",
  "MM_LITE_DEFAULT_AD_CAMPAIGN_GROUP",
  "Post do Instagram: Recebeu uma mensagem de um...",
...
const OUTROS: unknown[] = [
  ...
  [
    { external_id: "1", nome: "Post do Instagram: X", status: "ACTIVE", gasto: 17 },
    { external_id: "2", nome: "Traffic Campaign", status: "ACTIVE", gasto: 0 },
    { external_id: "3", nome: "Sales Campaign", status: "ACTIVE", gasto: 0 },
    { external_id: "4", nome: "MM_LITE_DEFAULT_AD_CAMPAIGN_GROUP", status: "ACTIVE", gasto: 0 },
    { external_id: "5", nome: "Post do Instagram: Y", status: "paused", gasto: 10 },
  ],
  { "1": 20.44, "2": 0 },
  [{ campaign_id: "1", nome: "Post A", gasto: 17, impressoes: 900, cliques_link: 50, formularios: 0, conversas: 0 }],
